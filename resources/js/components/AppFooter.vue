<template>
    <footer class="border-t border-white/5 bg-slate-900/80 backdrop-blur-sm shrink-0">
        <div class="max-w-7xl mx-auto px-3 sm:px-4 py-3">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-2">
                <p class="text-[10px] sm:text-xs text-slate-500 text-center sm:text-left">
                    Site fan non officiel, sans lien ni affiliation avec Blizzard Entertainment.
                    &copy; {{ new Date().getFullYear() }} WowPlanet.
                </p>
