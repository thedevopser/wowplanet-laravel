            ...
            <div class="h-12 sm:h-14 md:h-16 flex items-center justify-between gap-2 sm:gap-3">
                ...
                <div class="hidden sm:flex items-center gap-2 md:gap-3">
                    ...
                    <a
                        ...
                        class="flex items-center gap-1.5 px-3 md:px-4 py-1.5 rounded-md text-xs md:text-sm font-semibold text-white transition-opacity hover:opacity-90 whitespace-nowrap"
                ...
                <div class="flex sm:hidden items-center gap-2">
                    <a
                        ...
                        rel="noopener noreferrer"
                        aria-label="Rejoindre le Discord WowPlanet"
                        class="min-w-11 min-h-11 flex items-center justify-center rounded-lg text-white transition-opacity hover:opacity-90"
                        style="background-color: #5865F2;"
                    >
