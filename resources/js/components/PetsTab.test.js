...
describe('PetsTab', () => {
    it('renders the pets heading', () => {
        const wrapper = mount(PetsTab, { props: { character: makeCharacter(categorizedPets, 2) } });
    ...
    it('displays pet names sorted alphabetically', () => {
        const wrapper = mount(PetsTab, { props: { character: makeCharacter(samplePets) } });
    ...
    it('handles empty pets array', () => {
        const wrapper = mount(PetsTab, { props: { character: makeCharacter([], 0) } });
