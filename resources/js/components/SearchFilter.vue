<template>
    <div class="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
        <div class="relative flex-1">
            ...
            <button v-if="search" @click="$emit('update:search', '')" aria-label="Effacer la recherche" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-white transition-colors">
...
defineEmits(['update:search', 'update:hideCompleted']);
</script>
