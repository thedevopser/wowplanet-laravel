            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="py-2">
                            <a :href="item.creature_id ? `https://www.wowhead.com/fr/npc=${item.creature_id}` : `https://www.wowhead.com/fr/search?q=${encodeURIComponent(item.name_fr)}`" target="_blank" rel="noopener" class="text-slate-300 hover:text-blue-400 hover:underline">{{ item.name_fr }}</a>
                        </td>
